...
namespace InfrastructureDMS\Services;

use Chassis\Framework\Logger\Logger;
use Chassis\Framework\Services\AbstractService;
use InfrastructureDMS\Message\ApplicationMessage;
...
class DemoService extends AbstractService
{
    ...
    public function get()
    {
        ...
        $responseMessage = new ApplicationMessage(["my" => "body_response"], ["my" => "header_response"]);
        return $this->response($responseMessage, 200, "DONE");
    }
